    ...
    return (
        <>
           ...
           {/* {isOpen && <Paginacion selector="#botones" setIsOpen={setIsOpen} isOpen={isOpen} plato={plato} setPlato={setPlato} maximo={maximo} />}  */}
            ...
            <h2 className="text-black pt-2 ml-2 mb-2 font-bold dark:text-primary md:text-center md:pt-4 md:pb-4">HAMBURGUESAS</h2>
                ...
                <h2 className="text-black pt-2 ml-2 mb-2 font-bold dark:text-primary md:text-center md:pt-4 md:pb-4">PASTAS</h2>
                <div className={styles.ProductList}>
                    {products
                ...
                <h2 className="text-black pt-2 ml-2 mb-2 font-bold dark:text-primary md:text-center md:pt-4 md:pb-4">BEBIDAS</h2>
                <div className={styles.ProductList}>
                    {products
